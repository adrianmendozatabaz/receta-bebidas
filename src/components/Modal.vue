...
<template>
    <TransitionRoot as="template" :show="modal.modal">
        <Dialog as="div" class="relative z-10" @close="modal.handleClicModal">
                        ...
                        <DialogPanel
                            ...
                            <div>
                                <div class="mt-3">
                                    ...
                                    <img :src="bebidas.receta.strDrinkThumb" :alt="bebidas.receta.strDrink"
                            ...
                            <div class="mt-5 sm:mt-6 flex justify-between gap-4">
                                <button type="button"
                                    ...
                                    @click="modal.handleClicModal">Cerrar</button>
